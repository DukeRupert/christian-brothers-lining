...
services:
  - title: "CIPP Pipe Lining"
    description: "Trenchless technology that creates a new, corrosion-resistant pipe within your existing infrastructure."
    icon: '<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/></svg>'
    link: "/services/cipp-pipe-lining/"
  - title: "Manhole Rehabilitation"
    description: "Professional restoration services that protect and extend the life of your infrastructure."
    icon: '<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22V8"/><path d="M5 12H2a10 10 0 0 0 20 0h-3"/><path d="M5.5 8.5 9 12"/><path d="M18.5 8.5 15 12"/></svg>'
    link: "/services/manhole-rehabilitation/"
  - title: "CCTV Pipeline Inspection"
    description: "Advanced camera technology to assess pipe conditions and identify defects."
    icon: '<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z"/><circle cx="12" cy="13" r="3"/></svg>'
    link: "/services/cctv-pipeline-inspection/"
  - title: "Hydro Jetting"
    description: "High-pressure water cleaning to remove debris, roots, and buildup from pipelines."
    icon: '<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v20"/><path d="M2 12h20"/><circle cx="12" cy="12" r="4"/></svg>'
